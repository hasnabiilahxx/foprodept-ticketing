...
onMounted(() => {
    if (route.query.verified === '1') {
        verifiedMessage.value = 'Email berhasil diverifikasi! Silakan login kembali.'
    } else if (route.query.verified === 'already') {
        verifiedMessage.value = 'Email Anda sudah terverifikasi sebelumnya.'
    }
})
...
<template>
    <form class="space-y-6" @submit.prevent="handleSubmit">
        <div v-if="verifiedMessage" class="p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg text-sm">
